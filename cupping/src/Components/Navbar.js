...
function Navbar() {
  return (
    ...
    <img src="https://mlcecpvdmojs.i.optimole.com/w:auto/h:auto/q:mauto/f:best/https://cupping.app/wp-content/uploads/2023/04/cropped-Untitled-design-1.png" className="h-11" alt="Cupping app logo" />
    <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white ml-2">Cupping.app</span>
</div>
